    ...
    def main():
        ...
        for monthTextIndex, monthText in enumerate(assignmentData[0]):
            if monthText is None:
                assignmentData[0][monthTextIndex] = assignmentData[0][
                    monthTextIndex - 1
                ]
        ...
        for assignment in assignmentData:
            ...
            if monthIsValid:
                if weekIsValid:
                    assignmentDataGrouped.append(
                        [assignment[0], [[assignment[1], [assignment[3]]]]]
                    )
        ...
        for monthIndex, month in enumerate(assignmentDataGrouped):
            ...
            monthObject = {"id": monthIndex + 1, "month": monthCount, "week": weekList}

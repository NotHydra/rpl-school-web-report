...
def run_wanted_list():
    ...
    f = open("python/Wanted List/list_of_wanted_students_on_all_assignment.txt", "w")
    f.write("*WANTED* \n")
    ...
    f = open("python/Wanted List/list_of_wanted_students_on_latest_weekly_assignment.txt", "w")
    ...
    f = open("python/Wanted List/sorted_list_of_student_assignment.txt", "w")

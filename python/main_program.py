...
def write_table_names():
    ...
    for i in range(len(wb_mingguan_file)):
        wb_mingguan.append(openpyxl.load_workbook(f"excel/weekly/{wb_mingguan_file[i]}"))

    wb_bulanan = []
    for i in range(len(wb_bulanan_file)):
        wb_bulanan.append(openpyxl.load_workbook(f"excel/monthly/{wb_bulanan_file[i]}"))
    ...
    # Save Workbook
    for i in range(len(wb_mingguan_file)):
        wb_mingguan[i].save(f"excel/weekly/{wb_mingguan_file[i]}")


    for i in range(len(wb_bulanan_file)):
        wb_bulanan[i].save(f"excel/monthly/{wb_bulanan_file[i]}")
